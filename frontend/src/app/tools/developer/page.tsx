...
export default function DeveloperToolsPage() {
  const tools = getToolsByCategoryForList("developer");

  return (
    <div className="w-full min-h-screen grid-pattern relative">
      <div className="absolute top-0 left-0 w-full h-[400px] bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-violet-500/10 via-background to-transparent pointer-events-none -z-10" />
